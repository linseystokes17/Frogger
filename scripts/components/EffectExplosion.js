...
//
//------------------------------------------------------------------
Frogger.components.ParticleSystem.createEffectExplosion = function(spec) {
    'use strict';
    let effect = { };
    ...
    effect.update = function() {
        for (let particle = 0; particle < spec.howMany; particle += 1) {
            ...
            Frogger.components.ParticleSystem.createParticle({
                image: Frogger.assets.splat,
                alphaStart: 1.0,
                alphaEnd: 0.2,
    ...
    return Frogger.components.ParticleSystem.addEffect(effect);
};
